/**
 * @brief  	Functions for checking which instruction sets are supported.
 * 			It has been shamelessly stolen from [Agner Fog's implementation]
 * 			(http://www.agner.org/optimize/#vectorclass), which is licensed
 * 			under the GNU General Public License. Minor formatting modifications
 * 			were done; mostly cosmetic in nature.
 */
#include "instrset.h"
